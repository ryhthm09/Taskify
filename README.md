This is a todo list web application made using HTML CSS BootStrap.For backend I have used Nodejs express and the data is being saved in MongoDB Server
